...
namespace M3D.Spooling.Printer_Profiles
{
  internal class ProEEPROMConstants : EEPROMProfile
  {
      ...
      : base("Pro", 78, (ushort) 382, (ushort) 319, 2)
    {
      ...
      AddEepromAddressInfo(new EepromAddressInfo("BacklashExpansionXPlus", (ushort) 24, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("BacklashExpansionYLPlus", (ushort) 26, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("BacklashExpansionYRPlus", (ushort) 28, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("BacklashExpansionYRMinus", (ushort) 30, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("BacklashExpansionZ", (ushort) 32, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("BacklashExpansionE", (ushort) 34, 4, typeof (float)));
      ...
      AddEepromAddressInfo(new EepromAddressInfo("ReservedForSpooler", (ushort) 46, 4, typeof (float)));
      ...
      AddEepromAddressInfo(new EepromAddressInfo("SpeedLimitX", (ushort) 51, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("SpeedLimitY", (ushort) 53, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("SpeedLimitZ", (ushort) 55, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("SpeedLimitEp", (ushort) 57, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("SpeedLimitEn", (ushort) 59, 4, typeof (float)));
      ...
      AddEepromAddressInfo(new EepromAddressInfo("CalibrationOffset", (ushort) 70, 4, typeof (float)));
      ...
      AddEepromAddressInfo(new EepromAddressInfo("NozzleSizeExtrusionWidth", (ushort) 75, 2, typeof (ushort)));
      ...
      AddEepromAddressInfo(new EepromAddressInfo("SerialNumber", (ushort) 320, 4, typeof (uint)));
      AddEepromAddressInfo(new EepromAddressInfo("FANTYPE", (ushort) 341, 2, typeof (ushort)));
      AddEepromAddressInfo(new EepromAddressInfo("FANOFFSET", (ushort) 342, 2, typeof (ushort)));
      AddEepromAddressInfo(new EepromAddressInfo("FANSCALE", (ushort) 343, 4, typeof (float)));
      AddEepromAddressInfo(new EepromAddressInfo("HeaterCalibrationMode", (ushort) 345, 2, typeof (ushort)));
      AddEepromAddressInfo(new EepromAddressInfo("HardwareStatus", (ushort) 348, 2, typeof (ushort)));
      AddEepromAddressInfo(new EepromAddressInfo("HeaterTempMeasure_B", (ushort) 349, 4, typeof (float)));
