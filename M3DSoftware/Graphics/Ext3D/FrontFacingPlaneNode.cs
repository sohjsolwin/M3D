...
namespace M3D.Graphics.Ext3D
{
  public class FrontFacingPlaneNode : CustomShape
  {
    ...
    public void Create(M3D.Model.Utils.Vector3 pos, float xWidth, float zWidth, int opengl_texture_handle)
    {
      ...
      float num2 = zWidth / 2f;
      M3D.Model.Utils.Vector3 vector3_1 = new M3D.Model.Utils.Vector3(pos.x + num1, pos.y, pos.z + num2);
      M3D.Model.Utils.Vector3 vector3_2 = new M3D.Model.Utils.Vector3(pos.x - num1, pos.y, pos.z - num2);
