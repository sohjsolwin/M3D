...
namespace M3D.GUI.ManageFilament.Child_Frames
{
  internal class FilamentCloseBedInstructions : Manage3DInkChildWindow
  {
    ...
    public override void MyButtonCallback(ButtonWidget button)
    {
      ...
      MainWindow.TurnOnHeater(new AsyncCallback(MainWindow.GotoPageAfterOperation), new Manage3DInkMainWindow.PageAfterLockDetails(selectedPrinter, Manage3DInkMainWindow.PageID.Page17_CleanNozzle, CurrentDetails), 150, CurrentDetails.current_spool.filament_type);
    }
